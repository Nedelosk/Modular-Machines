...
public enum PacketId {
	MODULE_CLEANER, ASSEMBLER_POSITION, SELECT_MODULE, SELECT_PAGE, SYNC_HANDLER_STATE, SYNC_HEAT, SYNC_REDSTONE_MODE, SYNC_MODE, SYNC_PERMISSON, SYNC_MODULE, UPDATE_MODULE, ACTIVE_MODULE_BEE_LOGIC;
