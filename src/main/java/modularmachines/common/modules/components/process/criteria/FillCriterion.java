...
public class FillCriterion extends AbstractProcessCriterion<FluidStack> {
	...
	public void work() {
		...
		if (fluidHandler == null) {
			Log.err("Failed to fill a tank, because no fluid handler exist.");
			return;
		}
		fluidHandler.fill(requirement, true);
	}
	...
	public void updateState() {
		...
		int drainedFluid = fluidHandler.fill(requirement, false);
		setState(drainedFluid >= requirement.amount);
	}
}
