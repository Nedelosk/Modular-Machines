...
public abstract class WidgetEnergy extends Widget {
	...
	public List<String> getTooltip() {
		...
		if (source != null) {
			description.add(TextFormatting.WHITE + FORMAT.format(storage.getEnergyStored()) + " " + Translator.translateToLocal("mm.energy.of"));
			description.add(TextFormatting.WHITE + FORMAT.format(storage.getMaxEnergyStored()) + " " + TextFormatting.GRAY + Translator.translateToLocal("mm.energy.fe"));
		}
		return description;
	}
