...
public class BlockBlastFurnace extends BlockMultiblockBasic<MultiblockBlastFurnace> {
	...
	private static String[][] states = new String[][] {
			...
			{ "default" }, // Access Port
			{ "air", "slag", "output", "gas" }, // Fluid Port
	};
	...
	public static boolean isFluidPort(int metadata) {
		return metadata == METADATA_FLUIDPORT_AIR || metadata == METADATA_FLUIDPORT_OUTPUT
				|| metadata == METADATA_FLUIDPORT_SLAG || metadata == METADATA_FLUIDPORT_GAS;
	}
