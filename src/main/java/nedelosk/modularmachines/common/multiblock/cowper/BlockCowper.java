...
public class BlockCowper extends BlockMultiblockBasic<MultiblockCowper> {
	...
	private static String[][] states = new String[][] {
			...
			{ "default" }, // Access Port
			{ "input", "fuel", "output", "steam" }, // Fluid Port
			{ "default" } }; // Muffler
	...
	public static boolean isFluidPort(int metadata) {
		return metadata == METADATA_FLUIDPORT_INPUT || metadata == METADATA_FLUIDPORT_OUTPUT
				|| metadata == METADATA_FLUIDPORT_FUEL || metadata == METADATA_FLUIDPORT_STEAM;
	}
