...
public class ContainerModularMachine extends ContainerBase<TileModular> {
	...
	protected void addSlots(InventoryPlayer inventoryPlayer) {
		...
		if (stack.getProducer() instanceof IProducerInventory) {
			if (((IProducerInventory) stack.getProducer()).addSlots(this, this.inventoryBase.modular, stack) != null && !((IProducerInventory) stack.getProducer()).addSlots(this, this.inventoryBase.modular, stack).isEmpty()) {
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotID){
        ...
        try{
        	stack = inventoryBase.modular.getGuiManager().getModuleWithGui(player, inventoryBase);
        }catch(Exception e){
        	stack = null;
        }
