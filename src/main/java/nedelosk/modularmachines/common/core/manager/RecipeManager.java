...
public class RecipeManager {
	...
	public static void registerMetalRecipes()
	{
		...
		GameRegistry.addSmelting(new ItemStack(MMItemManager.Dusts.item(), 1, 5), new ItemStack(FItemManager.Ingots.item(), 1, 0), 0.5F);
		GameRegistry.addSmelting(new ItemStack(MMItemManager.Dusts.item(), 1, 6), new ItemStack(FItemManager.Ingots.item(), 1, 1), 0.5F);
		GameRegistry.addSmelting(new ItemStack(MMItemManager.Dusts.item(), 1, 7), new ItemStack(FItemManager.Ingots.item(), 1, 2), 0.5F);
		GameRegistry.addSmelting(new ItemStack(MMItemManager.Dusts.item(), 1, 8), new ItemStack(FItemManager.Ingots.item(), 1, 3), 0.5F);
		GameRegistry.addSmelting(new ItemStack(MMItemManager.Dusts.item(), 1, 9), new ItemStack(FItemManager.Ingots.item(), 1, 4), 0.5F);
