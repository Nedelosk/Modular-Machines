...
public class ModuleModuleAssemblerGui extends ModuleMachineRecipeGui<ModuleModuleAssembler> {
	...
	@Override
	public void addWidgets(IGuiBase gui, IModular modular, ModuleStack<ModuleModuleAssembler> stack, List<Widget> widgets) {
