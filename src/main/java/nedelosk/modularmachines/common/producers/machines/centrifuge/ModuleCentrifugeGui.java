...
public class ModuleCentrifugeGui extends ModuleMachineRecipeGui<ModuleCentrifuge> {

	public ModuleCentrifugeGui(String categoryUID, String guiName) {
		super(categoryUID, guiName);
	}

	@Override
	public void addWidgets(IGuiBase gui, IModular modular, ModuleStack<ModuleCentrifuge> stack, List<Widget> widgets) {
