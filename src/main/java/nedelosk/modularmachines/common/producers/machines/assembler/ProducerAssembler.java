...
public class ProducerAssembler extends ProducerMachineRecipe {

	public ProducerAssembler() {
		this(75);
	}

	public ProducerAssembler(int speedModifier) {
		super("Assembler", 2, 2, speedModifier);
	}

	public ProducerAssembler(NBTTagCompound nbt, IModular modular, ModuleStack stack) {
