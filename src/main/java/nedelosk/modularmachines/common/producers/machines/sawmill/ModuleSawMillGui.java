...
public class ModuleSawMillGui extends ModuleMachineRecipeGui<ModuleSawMill> {
	...
	@Override
	public void addWidgets(IGuiBase gui, IModular modular, ModuleStack<ModuleSawMill> stack, List<Widget> widgets) {
