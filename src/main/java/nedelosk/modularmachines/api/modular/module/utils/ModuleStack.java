package nedelosk.modularmachines.api.modular.module.utils;
...
public final class ModuleStack<M extends IModule> {
	...
	public void readFromNBT(NBTTagCompound nbt, IModular modular) {
		module = ModularManager.moduleFactory.createModule(nbt.getString("ModuleName"), nbt.getCompoundTag("Module"), modular);
