...
public interface IWailaData {
	 ...
	 * 
	 * modName is the name of the module to add the option to (ie : Buildcraft,
	 * IndustrialCraft2, etc) key is the config key (ie : bc.tankcontent,
	 * ic2.inputvalue) name is the human readable name of the option (ie :
	 * "Tank content", "Max EU Input")
	 */
