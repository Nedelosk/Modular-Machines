...
public class ButtonTabTankManager extends Button<IModularTileEntity<IModular>> {
	...
	public ButtonTabTankManager(int p_i1021_1_, int p_i1021_2_, int p_i1021_3_,
			ModuleStack<IModule, IProducerTankManager> stack, boolean down, int tabID) {
	...
	public void drawButton(Minecraft mc, int mx, int my) {
		...
		machine.drawTexturedModalRect(xPosition, yPosition, manager.getTab() == tabID ? 74 : 103, down ? 237 : 218, 29,
				19);
