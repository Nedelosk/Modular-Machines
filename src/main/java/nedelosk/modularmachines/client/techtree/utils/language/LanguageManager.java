...
public class LanguageManager implements ILanguageManager {
	...
	public static final Gson GSON = new GsonBuilder().setPrettyPrinting().registerTypeAdapter(TechTreeEntryLanguageData.class, new TechTreeEntryLanguage.Serializer()).registerTypeAdapter(TechTreeEntryLanguageData.class, new TechTreeEntryLanguage.Deserializer()).registerTypeAdapter(TechTreeCategoryLanguageData.class, new TechTreeCategoryLanguage.Serializer()).registerTypeAdapter(TechTreeCategoryLanguageData.class, new TechTreeCategoryLanguage.Deserializer()).create();
	public static LinkedHashMap<String, ILanguageData> languageData = new LinkedHashMap<String, ILanguageData>();
	
	public static void init(){
		if(instance == null)
			instance = new LanguageManager();
		ModularMachinesApi.languageManager = instance;
	}
	...
	public static class TechTreeEntryLanguage{
		...
		public static class Deserializer implements JsonDeserializer<TechTreeEntryLanguageData>{
			...
			public TechTreeEntryLanguageData parseEntryLanguageData(JsonElement json){
				String language = ModularMachinesApi.currentLanguage;
