...
public class GuiModuleRegisterError extends GuiScreen {
	...
	public void drawScreen(int mx, int my, float p_73863_3_) {
		...
		int i = 0;
		fontRendererObj.drawString("The Module " + ModularManager.getRegisterFailed().getName() + " has been registered twice for the same name.", width / 2- 220, height / 2, 16777215);
