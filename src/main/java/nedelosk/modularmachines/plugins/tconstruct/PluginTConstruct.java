...
public class PluginTConstruct extends Plugin{
	...
	public void init() {
		...
		FluidType.registerFluidType("niobium", MMBlocks.Metal_Blocks.block(), 10, 600, MMCore.Niobium, true);
		FluidType.registerFluidType("tantalum", MMBlocks.Metal_Blocks.block(), 11, 600, MMCore.Tantalum, true);
