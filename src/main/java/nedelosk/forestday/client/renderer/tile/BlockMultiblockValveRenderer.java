...
import nedelosk.forestday.common.blocks.BlockMultiblockValve;
...
public class BlockMultiblockValveRenderer implements ISimpleBlockRenderingHandler, IItemRenderer {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
		...
		BlockMultiblockValve.valveType = ((TileMultiblockBase) world.getTileEntity(x, y, z)).modifier.valveType != null
				? ((TileMultiblockBase) world.getTileEntity(x, y, z)).modifier.valveType : ValveType.DEFAULT;
		renderblocks.setRenderBoundsFromBlock(block);
		renderblocks.renderStandardBlock(block, x, y, z);
		return true;
	}
	 ...
	 * NCBlockManager.Multiblock_Valve.block().getRenderType(); }
	 * 
	 ...
	 * 
	 * BlockMultiblock.renderPass = 0; BlockMultiblockValve.renderPass = 0;
	 * renderItem(renderer, stack.getItemDamage(),
	 * NCBlockManager.Multiblock_Valve.block().getIcon(0,
	 * stack.getItemDamage())); BlockMultiblockValve.renderPass = 1;
	 * BlockMultiblockValve.valveType = ValveType.DEFAULT; renderItem(renderer,
	 * stack.getItemDamage(), NCBlockManager.Multiblock_Valve.block().getIcon(0,
	 * stack.getItemDamage()));
	 * 
	 * GL11.glPopAttrib(); }
	 * 
