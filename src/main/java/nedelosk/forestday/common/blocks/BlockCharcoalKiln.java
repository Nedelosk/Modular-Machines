...
public class BlockCharcoalKiln extends BlockMultiblockBase {
	...
	public void randomDisplayTick(World world, int x, int y, int z, Random random) {
		if (world.getBlockMetadata(x, y, z) == 0) {
			if (((TileCharcoalKiln) world.getTileEntity(x, y, z)).master != null
					&& ((TileCharcoalKiln) world.getTileEntity(x, y, z)).master.isMultiblock()
					|| ((TileCharcoalKiln) world.getTileEntity(x, y, z)).isMaster
							&& ((TileCharcoalKiln) world.getTileEntity(x, y, z)).isMultiblock) {
				if (((TileCharcoalKiln) world.getTileEntity(x, y, z)).isWorking()
						|| ((TileCharcoalKiln) world.getTileEntity(x, y, z)).master != null
								&& ((TileCharcoalKiln) world.getTileEntity(x, y, z)).master.isWorking()) {
					float f = x + 0.5F;
