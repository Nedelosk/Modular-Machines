...
import nedelosk.forestday.client.machines.brick.gui.GuiHeatGenerator;
...
import nedelosk.nedeloskcore.common.blocks.tile.TileBasePowerd;
...
public class TileHeatGenerator extends TileBricks {
	...
	public void updateServer() {
		...
		heat = heatModifiers[0] * heatModifiers[1] * heatModifiers[2];
