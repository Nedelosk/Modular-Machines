...
public class WorkbenchRecipeHandler {
	...
	@ZenMethod
	public static void add(IIngredient output, IIngredient input, IIngredient inputTool, IIngredient inputPattern,
			int burnTime) {
	...
	private static class AddAction implements IUndoableAction {
		...
		public AddAction(ItemStack parent1ToAdd, ItemStack parent2ToAdd, ItemStack parent3ToAdd, ItemStack output,
				int burnTime) {
