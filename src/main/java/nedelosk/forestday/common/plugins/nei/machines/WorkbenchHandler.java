...
public class WorkbenchHandler extends TemplateRecipeHandler {
  ...
  public void loadTransferRects() {
    transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(44, 37, 76, 17), "ForestDayWorkbench", new Object[0]));
  }
  ...
  public void loadCraftingRecipes(ItemStack result) {
    ...
    for (WorkbenchRecipe recipe : recipes) {
    	if(recipe.getOutput().getItem() == result.getItem() && recipe.getOutput().getItemDamage() == result.getItemDamage())
    	{
 	    ...
 	    boolean notPattern = false;
 	    	...
 	    	{
 	    		WorkbenchCachedRecipe res = new WorkbenchCachedRecipe(input, inputTool, inputPattern, recipe.getOutput());
  ...
  public class WorkbenchCachedRecipe extends TemplateRecipeHandler.CachedRecipe {
	...
	public WorkbenchCachedRecipe(List<ItemStack> input, List<ItemStack> inputTool, List<ItemStack> inputPattern, ItemStack output) {
