...
public class ModuleCore extends AModule {
	...
	public void preInit(IModuleManager manager) {
		...
		/*manager.register(BlockManager.Multiblock, new BlockMultiblock(), ItemBlockMultiblock.class);
		GameRegistry.registerTileEntity(TileMultiblockBase.class, "tile.multiblock.base");
		manager.register(BlockManager.Multiblock_Valve, new BlockMultiblockValve(), ItemBlockMultiblock.class);
		...
		manager.register(ItemManager.Bucket_Wood_Water, new ItemWoodBucket(Blocks.water, "bucket.wood.water").setContainerItem(ItemManager.Bucket_Wood.getObject()));
		FluidContainerRegistry.registerFluidContainer(FluidRegistry.WATER, new ItemStack(ItemManager.Bucket_Wood_Water.getObject()), new ItemStack(ItemManager.Bucket_Wood.getObject()));
	...
	public static void addNormalRecipes(){
		...
		addShapelessRecipe(new ItemStack(ItemManager.Tool_Parts.item(), 1, 1), new ItemStack(Blocks.stone_slab, 1, 3), new ItemStack(Blocks.stone_slab, 1, 3), Items.flint, Items.flint);
		...
		addShapelessRecipe(new ItemStack(ItemManager.Tool_Parts.item(), 1, 5), new ItemStack(Blocks.stone_slab, 1, 3), new ItemStack(Blocks.stone_slab, 1, 3), new ItemStack(Blocks.stone_slab, 1, 3), Items.flint);
		...
		addShapelessRecipe(new ItemStack(ItemManager.File_Stone.item()), new ItemStack(ItemManager.Tool_Parts.item(), 1, 0), new ItemStack(ItemManager.Tool_Parts.item(), 1, 1));
		addShapelessRecipe(new ItemStack(ItemManager.File_Iron.item()), new ItemStack(ItemManager.Tool_Parts.item(), 1, 0), new ItemStack(ItemManager.Tool_Parts.item(), 1, 2));
		addShapelessRecipe(new ItemStack(ItemManager.File_Diamond.item()), new ItemStack(ItemManager.Tool_Parts.item(), 1, 0), new ItemStack(ItemManager.Tool_Parts.item(), 1, 3));
		addShapelessRecipe(new ItemStack(ItemManager.Knife_Stone.item()), new ItemStack(ItemManager.Tool_Parts.item(), 1, 4), new ItemStack(ItemManager.Tool_Parts.item(), 1, 5));
		addShapelessRecipe(new ItemStack(ItemManager.Cutter.item()), new ItemStack(ItemManager.Tool_Parts.item(), 1, 6), new ItemStack(ItemManager.Tool_Parts.item(), 1, 7));
		addShapelessRecipe(new ItemStack(ItemManager.Adze.item()), new ItemStack(ItemManager.Tool_Parts.item(), 1, 8), new ItemStack(ItemManager.Tool_Parts.item(), 1, 10));
		addShapelessRecipe(new ItemStack(ItemManager.Adze_Long.item()), new ItemStack(ItemManager.Tool_Parts.item(), 1, 9), new ItemStack(ItemManager.Tool_Parts.item(), 1, 11));
		addShapedRecipe(new ItemStack(ItemManager.Hammer.item()), "+++", "+++", " - ", '+', "ingotIron", '-', "stickWood");
		
		addShapelessRecipe(new ItemStack(ItemManager.Nature.item(), 1, 8), Blocks.sand, Blocks.sand, Blocks.gravel, Blocks.gravel, Items.water_bucket);
		addShapelessRecipe(new ItemStack(ItemManager.Nature.item(), 1, 8), Blocks.sand, Blocks.sand, Blocks.gravel, Blocks.gravel, ItemManager.Bucket_Wood_Water.item());
		
		GameRegistry.addSmelting(new ItemStack(ItemManager.Crop_Corn.item()), new ItemStack(ItemManager.Nature.item(), 1, 9), 0.5F);
		GameRegistry.addSmelting(new ItemStack(ItemManager.Nature.item(), 1, 10), new ItemStack(ItemManager.Nature.item(), 1, 11), 0.5F);
		addShapedRecipe(new ItemStack(ItemManager.Nature.item(), 1, 10), "+++", "+++", "+++", '+', new ItemStack(ItemManager.Nature.item(), 1, 9));
	...
	public static void addWorkbenchRecipes(){
		workbench.addRecipe(new OreStack("plankWood"), new OreStack("toolFile"), new ItemStack(ItemManager.Gears_Wood.item(), 1, 5), ForestDayConfig.worktableBurnTime);
		workbench.addRecipe(new ItemStack(ItemManager.Gears_Wood.item(), 1, 5), new OreStack("toolFile"), new ItemStack(ItemManager.Gears_Wood.item(), 1, 4), ForestDayConfig.worktableBurnTime);
		workbench.addRecipe(new ItemStack(ItemManager.Gears_Wood.item(), 1, 4), new OreStack("toolFile"), new ItemStack(ItemManager.Gears_Wood.item(), 1, 3), ForestDayConfig.worktableBurnTime);
		workbench.addRecipe(new ItemStack(ItemManager.Gears_Wood.item(), 1, 3), new OreStack("toolFile"), new ItemStack(ItemManager.Gears_Wood.item(), 1, 2), ForestDayConfig.worktableBurnTime);
		workbench.addRecipe(new ItemStack(ItemManager.Gears_Wood.item(), 1, 2), new OreStack("toolFile"), new ItemStack(ItemManager.Gears_Wood.item(), 1, 1), ForestDayConfig.worktableBurnTime);
		workbench.addRecipe(new OreStack("plankWood"), new OreStack("toolKnife"), new ItemStack(ItemManager.Bucket_Wood.item()), ForestDayConfig.worktableBurnTime);
	...
	public static void addMachineRecipes(){
		...
		addShapedRecipe(new ItemStack(BlockManager.Machine.item(), 1, 2), "---", "+++", "WCW", '-', Blocks.crafting_table, '+', "slabWood", 'W', "logWood", 'C', Blocks.chest);
		addShapelessRecipe(new ItemStack(BlockManager.Machine.item(), 1, 2), new ItemStack(BlockManager.Machine.item(), 1, 1), Blocks.chest);
		addShapedRecipe(new ItemStack(BlockManager.Machine.item(), 1, 3), "ILI", "ICI", "ILI", 'I', "ingotIron", 'C', Blocks.chest, 'L', BlockManager.Gravel.item());
