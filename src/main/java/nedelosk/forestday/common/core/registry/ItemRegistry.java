...
public class ItemRegistry {
	...
	public static void preInit() {
		FItemManager.Crop_Corn
				.registerItem(new ItemSeedFood(2, 0.4F, FBlockManager.Crop_Corn.block(), Blocks.farmland) {
					@Override
		...
		FItemManager.Bucket_Wood_Water.registerItem(new ItemWoodBucket(Blocks.water, "bucket.wood.water").setContainerItem(FItemManager.Bucket_Wood.item()));
