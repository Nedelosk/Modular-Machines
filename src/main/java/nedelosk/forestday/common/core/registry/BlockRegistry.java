...
public class BlockRegistry {
	...
	public static void preInit()
	{
		...
		FBlockManager.Machine_Wood_Base.registerBlock(new BlockMachinesWood("wood_base", TileCampfire.class, TileWorkbench.class, TileWorkbench.class, TileKiln.class), ItemBlockMachines.class);
		...
		//FBlockManager.Multiblock.registerBlock(new BlockMultiblock(), ItemBlockMultiblock.class);
		//FBlockManager.Multiblock_Valve.registerBlock(new BlockMultiblockValve(), ItemBlockMultiblock.class);
