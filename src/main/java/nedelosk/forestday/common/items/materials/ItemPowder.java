...
public class ItemPowder extends ItemForestday {

	public String[] textures = new String[] { "copper", "tin", "iron", "gold", "stone", "lapis_lazuli", "diamond", "emerald", "coal" };
    ...
    public void registerIcons (IIconRegister iconRegister)
    {
        ...
        {
            this.itemIcon[i] = iconRegister.registerIcon("forestday:powder/" + textures[i]);
        }
    }
    ...
    {
        return ForestdayRegistry.setUnlocalizedItemName("powder." + itemstack.getItemDamage());
    }
