...
public class ModuleCore extends AModule {
	...
	public void preInit(IModuleManager manager) {
		...
		manager.register(BlockManager.Ore, new BlockOre(BlockOre.ores, "forestday"), ItemBlockForest.class);
	...
	public static void addNormalRecipes() {
		...
		addShapelessRecipe(new ItemStack(ItemManager.Nature.item(), 1, 8), Blocks.sand, Blocks.sand, Blocks.gravel, Blocks.gravel,
				ItemManager.Bucket_Wood_Water.item());
	...
	public static void addWorkbenchRecipes() {
		workbench.addRecipe(new OreStack("plankWood"), new OreStack("toolFile"), new ItemStack(ItemManager.Gears_Wood.item(), 1, 5),
				ForestDayConfig.worktableBurnTime);
		...
		workbench.addRecipe(new ItemStack(ItemManager.Gears_Wood.item(), 1, 2), new OreStack("toolFile"), new ItemStack(ItemManager.Gears_Wood.item(), 1, 1),
				ForestDayConfig.worktableBurnTime);
		workbench.addRecipe(new OreStack("plankWood"), new OreStack("toolKnife"), new ItemStack(ItemManager.Bucket_Wood.item()),
				ForestDayConfig.worktableBurnTime);
	...
	public static enum ItemManager implements IItemManager {
		Nature, Crop_Corn, Bucket_Wood, Bucket_Wood_Water, Ingots, Nuggets, Gems, Gears_Wood,
		// Campfire
		Curb, Pot, Pot_Holder,
		// Tools
