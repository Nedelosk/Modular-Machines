...
public class ItemPlates extends ItemForestday {

	public String[] textures = new String[] { "steel", "light_steel", "dark_steel", "obsidian", "enderium" };
    ...
    public void registerIcons (IIconRegister iconRegister)
    {
        ...
        {
            this.itemIcon[i] = iconRegister.registerIcon("forestday:plate/" + textures[i]);
        }
    }
    ...
    {
        return ForestdayRegistry.setUnlocalizedItemName("build.material.plate." + itemstack.getItemDamage());
    }
