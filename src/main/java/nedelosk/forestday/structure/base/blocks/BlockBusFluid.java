...
public class BlockBusFluid extends BlockContainer {

	public BlockBusFluid() {
		super(Material.iron);
		this.setCreativeTab(Tabs.tabForestdayMultiBlocks);
		this.setBlockName("structure.bus.fluid");
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		switch (meta) {
		case 0:
			return new TileBusFluid(75, "Loam", icons[0]);
		case 1:
			return new TileBusFluid(125, "Ash", icons[1]);
		case 2:
			return new TileBusFluid(250, "Hardened", icons[2]);
		case 3:
			return new TileBusFluid(500, "Steel", icons[3]);
		case 4:
			return new TileBusFluid(1000, "Obsidian", icons[4]);
		case 5:
			return new TileBusFluid(2000, "Enderium", icons[5]);
		default:
			return null;
		}
	}
