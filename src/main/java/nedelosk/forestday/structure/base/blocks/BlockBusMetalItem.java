...
public class BlockBusMetalItem extends BlockContainer {

	public BlockBusMetalItem() {
		super(Material.iron);
		this.setCreativeTab(Tabs.tabForestdayMultiBlocks);
		this.setBlockName("structure.bus.metal");
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		switch (meta) {
		case 0:
			return new TileBusItem(125, "Steel", icons[0]);
		case 1:
			return new TileBusItem(250, "LightSteel", icons[1]);
		case 2:
			return new TileBusItem(500, "DarkSteel", icons[2]);
		case 3:
			return new TileBusItem(1000, "Obsidian", icons[3]);
		case 4:
			return new TileBusItem(2000, "Enderium", icons[4]);
		default:
			return null;
		}
	}
