package nedelosk.forestday.structure.alloysmelter.gui;
...
public class GuiAlloySmelterController extends GuiController {

	private TileAlloySmelterController tile;
	private ResourceLocation guiTexture = new ResourceLocation("forestday", "textures/gui/controller.png");
	
	public GuiAlloySmelterController(InventoryPlayer inventory, TileAlloySmelterController tile) {
