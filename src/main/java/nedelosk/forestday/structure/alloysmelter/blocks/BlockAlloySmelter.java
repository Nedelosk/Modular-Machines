package nedelosk.forestday.structure.alloysmelter.blocks;
...
public class BlockAlloySmelter extends BlockMachieneBase {
	...
	public BlockAlloySmelter() {
		...
		this.setBlockName("machine.furnace.alloy");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float par7, float par8, float par9) {
		...
		if(world.getTileEntity(x, y,z) instanceof TileAlloySmelterRegulator)
		{
		FMLNetworkHandler.openGui(player, Forestday.instance, 7, world, x, y, z);
		}
		if(world.getTileEntity(x, y,z) instanceof TileAlloySmelterController)
		{
    ...
    public void registerBlockIcons (IIconRegister iconRegister)
    {
    	icons = new IIcon[3];
    	//Brick
        icons[meta_controller] = iconRegister.registerIcon("forestday:controllers/smelter_alloy_controller");
        icons[meta_regulator] = iconRegister.registerIcon("forestday:regulators/smelter_alloy_regulator");
	...
	public TileEntity createNewTileEntity(World world, int meta) {
			switch (meta) {
			case 0:
				return new TileAlloySmelterController();
			case 1:
				return new TileAlloySmelterRegulator();
			default:
				return null;
			}
	}
