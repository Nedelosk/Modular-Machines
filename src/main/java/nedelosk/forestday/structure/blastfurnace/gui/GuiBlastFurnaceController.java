package nedelosk.forestday.structure.blastfurnace.gui;
...
public class GuiBlastFurnaceController extends GuiController {

	private TileBlastFurnaceController tile;
	private ResourceLocation guiTexture = new ResourceLocation("forestday", "textures/gui/controller.png");
	
	public GuiBlastFurnaceController(InventoryPlayer inventory, TileBlastFurnaceController tile) {
