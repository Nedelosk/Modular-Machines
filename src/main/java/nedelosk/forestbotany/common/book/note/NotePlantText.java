package nedelosk.forestbotany.common.book.note;
...
public class NotePlantText extends Note {

	public IPlant plant;
	
	public NotePlantText(String unlocalizedName, int id, BookData data, IPlant plant) {
