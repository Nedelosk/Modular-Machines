package de.nedelosk.forestmods.api.modules.handlers.inventory.slots;
...
public class SlotModule extends Slot {
	...
	public SlotModule(ModuleStack stack, int index, int xPosition, int yPosition) {
		super(stack.getModule().getInventory(), index, xPosition, yPosition);
