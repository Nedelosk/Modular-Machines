...
public class SlotModularInput extends SlotModular {
	...
	public <M extends IModuleMachineRecipe, S extends IModuleSaver> SlotModularInput(IInventory p_i1824_1_, int p_i1824_2_, int p_i1824_3_, int p_i1824_4_,
			ModuleStack<M, S> stack) {
	...
	public boolean isItemValid(ItemStack stack) {
		return RecipeRegistry.isRecipeInput(recipeName, new RecipeItem(getSlotIndex(), stack));
	}
}
