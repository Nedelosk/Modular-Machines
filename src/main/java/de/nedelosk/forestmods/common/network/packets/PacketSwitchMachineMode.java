...
public class PacketSwitchMachineMode extends PacketTileEntity<TileEntity> implements IMessageHandler<PacketSwitchMachineMode, IMessage> {

	public int mode;

	public PacketSwitchMachineMode() {
		super();
	}

	public PacketSwitchMachineMode(TileEntity tile, IMachineMode mode) {
		super(tile);
	...
	@Override
	public IMessage onMessage(PacketSwitchMachineMode message, MessageContext ctx) {
		try {
