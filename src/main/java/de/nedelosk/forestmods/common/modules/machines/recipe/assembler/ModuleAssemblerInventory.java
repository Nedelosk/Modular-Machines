package de.nedelosk.forestmods.common.modules.machines.recipe.assembler;
...
public class ModuleAssemblerInventory extends ModuleMachineRecipeInventory<ModuleAssembler, IModuleMachineSaver> {
	...
	public ModuleAssemblerInventory(String UID, int slots) {
		super(UID, slots);
	}

	@Override
	public List<Slot> addSlots(IContainerBase container, IModularDefault modular, ModuleStack<ModuleAssembler, IModuleMachineSaver> stack) {
