...
public final class ModuleHandler implements IModuleHandler {
	...
	public ModuleHandler(ItemStack stack, ModuleStack moduleStack, boolean ignorNBT) {
		this.stack = stack;
	...
	@Override
	public ModuleHandler copy() {
		return new ModuleHandler(stack.copy(), moduleStack, ignorNBT);
	}
