...
import de.nedelosk.forestmods.common.modules.heater.ModuleHeaterBurning;
import de.nedelosk.forestmods.common.modules.machines.ModuleAlloySmelter;
import de.nedelosk.forestmods.common.modules.machines.ModulePulverizer;
import de.nedelosk.forestmods.common.modules.machines.ModuleSawMill;
import de.nedelosk.forestmods.common.modules.registry.ModuleContainer;
...
public enum EnumModules {
	...
	EnumModules(IMaterial material, ModuleUID UID, ItemStack defaultStack, boolean ignorNBT, Class<? extends IModule> moduleClass, Class<? extends IModuleContainer> containerClass, Object... parameters) {
		...
		ModuleManager.moduleRegistry.registerItemForModule(stack, getModuleContainer());
	}
