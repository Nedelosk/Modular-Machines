...
public class WidgetTextField<T extends IGuiHandler> extends Widget<T> {
	 ...
	 */
	private void drawCursorVertical(IGuiBase<T> gui, int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
		int i1;
		...
		if (p_146188_3_ > gui.getGuiLeft() + pos.x + pos.width) {
			p_146188_3_ = gui.getGuiLeft() + pos.x + pos.width;
		}
		if (p_146188_1_ > gui.getGuiLeft() + pos.x + pos.width) {
			p_146188_1_ = gui.getGuiLeft() + pos.x + pos.width;
		}
