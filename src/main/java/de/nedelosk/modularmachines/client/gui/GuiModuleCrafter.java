...
public class GuiModuleCrafter extends GuiBase<TileModuleCrafter> {
	...
	public void initGui() {
		super.initGui();
		//buttonList.add(nextButton = new GuiButtonExt(0, guiLeft - 29, guiTop + 135, buttonSize, buttonSize, nextLabel));
		//buttonList.add(backButton = new GuiButtonExt(1, guiLeft - 125, guiTop + 135, buttonSize, buttonSize, backLabel));
	}
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		//drawTexturedModalRect(this.guiLeft - 130, this.guiTop + 2, 0, 0, 126, 158);
	}
