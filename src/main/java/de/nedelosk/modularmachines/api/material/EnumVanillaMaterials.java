...
public enum EnumVanillaMaterials implements IMetalMaterial {
	WOOD(0, "Wood", "wood", 0x967853, "Wood"), COAL(1, "Coal", "coal", 0x3E3E3E, "Coal"), DIAMOND(6, "Diamond", "diamond", 0x68D2DA, "Diamond"), OBSIDIAN(6, "Obsidian", "obsidian", 0x7E258C, "Obdidian"), DIRT(-1, "Dirt", "dirt", 0x9A6D41, "Dirt");
