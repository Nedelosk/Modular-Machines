package de.nedelosk.modularmachines.api.modules.network;
...
public class DataOutputStreamMM extends DataOutputStream {

	public DataOutputStreamMM(OutputStream out) {
		super(out);
	}
