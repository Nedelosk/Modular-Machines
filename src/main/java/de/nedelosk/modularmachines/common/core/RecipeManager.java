...
public class RecipeManager {
	...
	private static void addModuleRecipes() {
		...
		addShapedRecipe(new ItemStack(BlockManager.blockModuleCrafter), "LCL", "CWC", "LCL", 'L', "logWood", 'C', "cobblestone", 'W', Blocks.CRAFTING_TABLE);
		// Casings
	...
	private static void registerAlloySmelterRecipes() {
		/* BRONZE */
		RecipeUtil.addAlloySmelter("DustDustToBronze", new RecipeItem(new OreStack("dustTin", 1)), new RecipeItem(new OreStack("dustCopper", 3)), new RecipeItem[] { new RecipeItem(ItemManager.itemIngots.getStack(EnumMetalMaterials.BRONZE, 4)) }, 11, 125,
				0.25);
		RecipeUtil.addAlloySmelter("DustIngotToBronze", new RecipeItem(new OreStack("ingotTin", 1)), new RecipeItem(new OreStack("ingotCopper", 3)), new RecipeItem[] { new RecipeItem(ItemManager.itemIngots.getStack(EnumMetalMaterials.BRONZE, 4)) }, 11,
				125, 0.25);
		/* INVAR */
		RecipeUtil.addAlloySmelter("DustDustToInvar", new RecipeItem(new OreStack("dustIron", 2)), new RecipeItem(new OreStack("dustNickel", 1)), new RecipeItem[] { new RecipeItem(ItemManager.itemIngots.getStack(EnumMetalMaterials.INVAR, 4)) }, 9, 175,
				0.5);
		RecipeUtil.addAlloySmelter("DustIngotToInvar", new RecipeItem(new OreStack("ingotIron", 2)), new RecipeItem(new OreStack("ingotNickel", 1)), new RecipeItem[] { new RecipeItem(ItemManager.itemIngots.getStack(EnumMetalMaterials.INVAR, 4)) }, 9, 175,
				0.5);
	}
