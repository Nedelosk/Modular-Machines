...
public class CharcoalKilnHandler extends TemplateRecipeHandler {
	...
	public void loadCraftingRecipes(ItemStack result) {
		...
		for(Entry<ItemStack, List<ItemStack>> entry : ModularMachinesApi.getCharcoalKilnDrops().entrySet()) {
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		...
		List<ItemStack> drops = ModularMachinesApi.getCharcoalDrops(ingredient);
		drops.add(new ItemStack(Items.coal, 8, 1));
