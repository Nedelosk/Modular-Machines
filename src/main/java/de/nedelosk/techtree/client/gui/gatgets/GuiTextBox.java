/*******************************************************************************
 * Copyright (c) 2011-2014 SirSengir. All rights reserved. This program and the
 ...
 *
 * Various Contributors including, but not limited to: SirSengir (original
...
public class GuiTextBox extends GuiTextField {
	...
	private void drawScrolledSplitString(String text, int startX, int startY, int width, int textColour) {
		...
		for ( String line : lines ) {
			...
			fontRendererObj.drawStringWithShadow(line, startX, lineY, textColour);
